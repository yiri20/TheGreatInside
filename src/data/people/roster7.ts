...
const seeds: PersonSeed[] = [
  ...
  },
  {
    ...
    sources: [{ id: "src_butler_wikipedia", kind: "wikipedia", title: "Octavia E. Butler", url: "https://en.wikipedia.org/wiki/Octavia_E._Butler" }, { id: "src_butler_huntington", kind: "archive", title: "The Huntington Library — Octavia E. Butler Papers (notebooks, journals, correspondence)" }, { id: "src_butler_macfound", kind: "award_body", title: "MacArthur Foundation — Octavia Butler, Class of 1995", url: "https://www.macfound.org/fellows/class-of-1995/octavia-butler" }, { id: "src_butler_nasa", kind: "institution", title: "NASA — Welcome to Octavia E. Butler Landing", url: "https://science.nasa.gov/resource/welcome-to-octavia-e-butler-landing/" }, { id: "src_butler_smithsonian", kind: "press", title: "Smithsonian Magazine — \"The Pioneering Sci-Fi Writer Octavia E. Butler Joins a Pantheon of Celebrated Futurists\"", url: "https://www.smithsonianmag.com/smithsonian-institution/pioneering-sci-fi-writer-octavia-e-butler-joins-pantheon-celebrated-futurists-180978255/" }],
    rows: {
