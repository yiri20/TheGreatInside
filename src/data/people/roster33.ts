...
const seeds: PersonSeed[] = [
  ...
  },
  {
    ...
    directoryVisible: true,
    sources: [{ id: "src_hitchcock_wikipedia", kind: "wikipedia", title: "Alfred Hitchcock", url: "https://en.wikipedia.org/wiki/Alfred_Hitchcock" }, { id: "src_hitchcock_truffaut", kind: "archive", title: "Francois Truffaut, Hitchcock/Truffaut (1966/1983) -- a week-long, fifty-hour recorded interview, his own extensive direct testimony" }],
    rows: {
