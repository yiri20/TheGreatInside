...
export const ko: Partial<Record<MessageKey, string>> & Partial<Record<PersonNameKey, string>> = {
  ...
  "people.directory.intro": "시대와 지역, 특성별로 살펴볼 수 있어요.",
  ...
  "people.directory.tags_label": "태그",
  "people.directory.tags_label_selected": "태그 ({count})",
  "people.directory.tags_clear": "태그 초기화",
