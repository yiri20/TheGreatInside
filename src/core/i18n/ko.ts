...
export const ko: Partial<Record<MessageKey, string>> & Partial<Record<PersonNameKey, string>> = {
  ...
  "occupation.aviator": "비행사",
  "occupation.chemist": "화학자",
  "occupation.composer": "작곡가",
  "occupation.musician": "음악가",
  "occupation.economist": "경제학자",
  ...
  "person.name.marcus-aurelius": "마르쿠스 아우렐리우스",

  // ROSTER-14 — coverage-aware intake (2026-09).
  "person.name.abraham-lincoln": "에이브러햄 링컨",
  "person.name.theodore-roosevelt": "시어도어 루스벨트",
  "person.name.alexander-hamilton": "알렉산더 해밀턴",
  "person.name.mark-twain": "마크 트웨인",
  "person.name.ernest-hemingway": "어니스트 헤밍웨이",
  "person.name.elizabeth-i": "엘리자베스 1세",
  "person.name.otto-von-bismarck": "오토 폰 비스마르크",
  "person.name.leo-tolstoy": "레프 톨스토이",
  "person.name.sigmund-freud": "지그문트 프로이트",
  ...
  // ROSTER-16 — final coverage-and-confidence-aware intake (2026-09).
  "person.name.duke-ellington": "듀크 엘링턴",
  "person.name.martha-graham": "마사 그레이엄",
  "person.name.bertrand-russell": "버트런드 러셀",
  "person.name.charles-dickens": "찰스 디킨스",
  "person.name.george-orwell": "조지 오웰",
  "person.name.t-e-lawrence": "T. E. 로렌스",
  "person.name.elizabeth-cady-stanton": "엘리자베스 케이디 스탠턴",
  "person.name.john-d-rockefeller": "존 D. 록펠러",
  "person.name.bette-davis": "베티 데이비스",
  "person.name.giuseppe-garibaldi": "주세페 가리발디",
  "person.name.anton-chekhov": "안톤 체호프",
  "person.name.nellie-bly": "넬리 블라이",
  "person.name.carl-jung": "카를 융",
  "person.name.vera-rubin": "베라 루빈",
  ...
  "person.name.lu-xun": "루쉰",
  "person.name.amelia-earhart": "아멜리아 에어하트",
  "person.name.zaha-hadid": "자하 하디드",
  "person.name.jorge-luis-borges": "호르헤 루이스 보르헤스",
  "person.name.norman-borlaug": "노먼 볼로그",
  "person.name.marie-tharp": "마리 사프",
  "person.name.jean-jacques-rousseau": "장자크 루소",
  "person.name.al-biruni": "알비루니",
  "person.name.hedy-lamarr": "헤디 라마",
  "person.name.rosa-parks": "로자 파크스",
  "person.name.ken-saro-wiwa": "켄 사로위와",
  "person.name.bob-marley": "밥 말리",
  "person.name.agatha-christie": "애거사 크리스티",
  "person.name.winston-churchill": "윈스턴 처칠",
  "person.name.thomas-jefferson": "토머스 제퍼슨",
  "person.name.sun-yat-sen": "쑨원",
  "person.name.katharine-hepburn": "캐서린 헵번",
  "person.name.henry-ford": "헨리 포드",
  "person.name.eleanor-roosevelt": "엘리너 루스벨트",
  "person.name.stephen-hawking": "스티븐 호킹",
  "person.name.diego-rivera": "디에고 리베라",
  "person.name.naguib-mahfouz": "나기브 마흐푸즈",
  "person.name.ida-b-wells": "아이다 B. 웰스",
  "person.name.junko-tabei": "다베이 준코",
  ...
  "person.name.linus-pauling": "라이너스 폴링",
  "person.name.robert-falcon-scott": "로버트 팰컨 스콧",
  "person.name.luis-alvarez": "루이스 앨버레즈",
  "person.name.ahmed-zewail": "아메드 즈웨일",
  "person.name.gregor-mendel": "그레고어 멘델",
  "person.name.emilio-segre": "에밀리오 세그레",
  "person.name.taha-hussein": "타하 후세인",
  "person.name.sofia-kovalevskaya": "소피야 코발렙스카야",
  "person.name.maria-goeppert-mayer": "마리아 괴퍼트메이어",
  "person.name.michael-faraday": "마이클 패러데이",
  "person.name.homi-bhabha": "호미 바바",
  "person.name.rosalyn-yalow": "로절린 얠로",
  "person.name.enrico-fermi": "엔리코 페르미",
  "person.name.dorothy-hodgkin": "도러시 호지킨",
  "person.name.pele": "펠레",
  "person.name.fahrelnissa-zeid": "파흐렐니사 제이드",
  "person.name.virginia-woolf": "버지니아 울프",
  "person.name.matsuo-basho": "마쓰오 바쇼",
  ...
  "person.name.bessie-coleman": "베시 콜먼",
  "person.name.valentina-tereshkova": "발렌티나 테레시코바",
  "person.name.margaret-hamilton": "마거릿 해밀턴",
  "person.name.robert-noyce": "로버트 노이스",
  "person.name.soichiro-honda": "혼다 소이치로",
  "person.name.milton-hershey": "밀턴 허쉬",
  "person.name.pina-bausch": "피나 바우쉬",
  "person.name.ansel-adams": "안셀 애덤스",
  "person.name.edith-piaf": "에디트 피아프",
  "person.name.gordon-parks": "고든 파크스",
  "person.name.tu-youyou": "투유유",
